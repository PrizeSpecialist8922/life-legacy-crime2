...
type HubView = "overview" | "politics" | "athlete" | "business" | "investing" | "crime" | "network";
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        ...
        <PathCard
          ...
          lines={[
            ...
            "Will require: fame, talent, an agent",
            "Income: Feast or famine",
          ]}
        />
        <PathCard
          icon={Skull}
        ...
        <PathCard
          ...
          title="Combat Sports"
          status="Future"
          lines={["Coming in a future build", "Will require: elite fitness & fight camps"]}
        />
        <PathCard
          icon={HeartHandshake}
          title="Secret Societies"
          status="Future"
          lines={["Coming in a future build", "By invitation only — network hard"]}
        />
        <PathCard
          icon={Crown}
